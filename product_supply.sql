...
CREATE TABLE `purchase_order` (
  ...
  `jd_purchase_other_number` char(11) DEFAULT NULL COMMENT '金蝶采购订单编码',
  `payment_method` int(255) DEFAULT NULL COMMENT '收付方式',
  `other_paymen_method_reason` varchar(255) DEFAULT NULL COMMENT '其他收付方式',
...
-- Records of workflew
-- ----------------------------
INSERT INTO `workflew` VALUES ('1', '采购支付申请审批流程', null);
...
CREATE TABLE `workflew_entity` (
  ...
  `workflew_id` int(11) DEFAULT NULL,
  `workflew_node_id` int(11) DEFAULT NULL,
  `entity_id` char(32) DEFAULT NULL COMMENT '表单实例id（例子：purchase_order:id）',
  `approver_id` int(11) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `workflew_node` VALUES ('1', '1', '1', '交付经理审批', null, '2');
INSERT INTO `workflew_node` VALUES ('2', '1', '2', '运营会计审批', '1', '3');
INSERT INTO `workflew_node` VALUES ('3', '1', '3', '总账会计审批', '2', null);
