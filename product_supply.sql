...
CREATE TABLE `dict` (
  ...
  `value` int(255) NOT NULL COMMENT '数值',
...
CREATE TABLE `material_info` (
  `atid` int(5) NOT NULL AUTO_INCREMENT COMMENT '自增计数',
  `number` varchar(255) NOT NULL COMMENT '物料代码',
  `material_name` varchar(255) DEFAULT NULL COMMENT '物料名称',
  `standard` varchar(255) DEFAULT NULL COMMENT '规格',
  `technology` varchar(255) DEFAULT NULL COMMENT '工艺',
  `brand` varchar(255) DEFAULT NULL COMMENT '品牌',
  `importance` varchar(255) DEFAULT NULL COMMENT '重要性',
  `field` varchar(255) DEFAULT NULL COMMENT '属性',
  `desc` varchar(255) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`atid`,`number`)
...
CREATE TABLE `material_requirement` (
  ...
  `type` int(2) DEFAULT NULL COMMENT '1、销售需求；2、生产需求；3、其他需求',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `material_stock` (
  `id` int(11) NOT NULL,
  `material_number` varchar(255) DEFAULT NULL COMMENT '物料编码',
  `warehouse_number` varchar(255) DEFAULT NULL COMMENT '仓库代码',
...
-- ----------------------------
-- Table structure for material_underway_stock
-- ----------------------------
DROP TABLE IF EXISTS `material_underway_stock`;
CREATE TABLE `material_underway_stock` (
  `id` int(11) NOT NULL,
  `material_number` varchar(255) DEFAULT NULL COMMENT '物料编码',
  `quantity` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `purchase_order` (
  `id` char(32) NOT NULL,
  `purchase_content` varchar(255) DEFAULT NULL COMMENT '采购内容',
  `order_amount` decimal(10,0) DEFAULT NULL COMMENT '订单金额',
  `supplier_id` char(255) DEFAULT NULL COMMENT '供应商ID',
  `order_number` int(11) DEFAULT NULL COMMENT '订单流码',
  `order_date` datetime DEFAULT NULL COMMENT '下单日期',
  `out_standing_amount` decimal(10,0) DEFAULT NULL COMMENT '未付金额',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  `process_status` varchar(255) DEFAULT NULL COMMENT '流程状态',
  `purchase_reason` varchar(255) DEFAULT NULL COMMENT '采购缘由',
  `other_purchase_reason_remark` varchar(255) DEFAULT NULL COMMENT '其他采购缘由说明',
  `goods_type` int(255) DEFAULT NULL COMMENT '商品类型',
  `order_remark` varchar(255) DEFAULT NULL COMMENT '订单备注',
  `amount_paid` int(11) DEFAULT NULL COMMENT '已付金额',
  `warehousing_status` varchar(255) DEFAULT NULL COMMENT '入库核销完成',
  `is_invoice` varchar(255) DEFAULT NULL COMMENT '有无发票',
  `invoice_type` varchar(255) DEFAULT NULL COMMENT '发票类型',
  `jd_purchase_ordernumber` char(11) DEFAULT NULL COMMENT '金蝶采购订单编码',
  `payment_method` int(255) DEFAULT NULL COMMENT '收付方式',
  `other_paymentmethod_reason` varchar(255) DEFAULT NULL COMMENT '其他收付方式',
  `full_payment_status` varchar(255) DEFAULT NULL COMMENT '订单支付完成',
  `warehousing` varchar(255) DEFAULT NULL COMMENT '入库单附件',
  `invoice` varchar(255) DEFAULT NULL COMMENT '发票附件',
  `all_material_quantity` varchar(255) DEFAULT NULL COMMENT '订单总物料数量',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `purchase_order_detail` (
  ...
  `material_number` varchar(255) DEFAULT NULL COMMENT '物料代码',
  `material_name` varchar(255) DEFAULT NULL COMMENT '物料名称',
  `material_quantity` int(11) DEFAULT NULL COMMENT '物料数量',
...
CREATE TABLE `supplier` (
  ...
  `supplier_taxes_number` varchar(11) DEFAULT NULL,
  `is_black_list` tinyint(255) DEFAULT NULL,
  `is_commodity_supplier` tinyint(255) DEFAULT NULL,
  `is_outsourcing_processors` tinyint(255) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for sys_sub_module
-- ----------------------------
DROP TABLE IF EXISTS `sys_sub_module`;
CREATE TABLE `sys_sub_module` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `path` varchar(255) DEFAULT NULL,
  `parent_id` int(11) DEFAULT NULL,
  `delete_mark` tinyint(4) DEFAULT NULL COMMENT '1：已删除；0：未删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
...
CREATE TABLE `warehouse_info` (
  `id` int(11) NOT NULL,
  `number` varchar(255) DEFAULT NULL COMMENT '仓库代码',
  `type` varchar(255) DEFAULT NULL COMMENT '仓库类型[1、公司仓；2、电商仓；3、外协仓；4、代销仓]',
  `name` varchar(255) DEFAULT NULL,
  `address` varchar(255) DEFAULT NULL,
  `supplier_id` varchar(255) DEFAULT NULL COMMENT '供应商id',
  `status` int(2) DEFAULT NULL COMMENT '1、在用；0、禁用',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
